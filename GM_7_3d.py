# -*- coding: utf-8 -*-
"""
Created on Fri Aug 22 11:54:21 2025
...
def Z(T, ratio):
    ...
    Ts = T # inputted T mesh from temperature mesh array
...
# plt.title('1C$_3$H$_8$O$_3$:5H$_2$O')
# plt.legend()
# plt.show()
...
x = np.linspace(473.15, 1173.15, 40) # temperature (K) range for testing
y = np.linspace(0.5, 5, 40) # mole flow ratio - h2o/methanol
X, Y = np.meshgrid(x, y)
h2, h2o, co2, ch4, co, c = Z(X, Y)
